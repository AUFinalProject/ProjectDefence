...
\begin{tabular}{|M{2.0cm}|M{2.0cm}|M{2.0cm}|M{2.0cm}|M{2.0cm}|}
	...
	\hline
	\centering{\textbf{AdaBoost Classifier}} & \centering{40} & \centering{3} & \centering{1} & \centering{40}\tabularnewline
	\hline
	\centering{\textbf{AdaBoost Regressor}} & \centering{39} & \centering{4} & \centering{2} & \centering{39}\tabularnewline
	\hline
	\centering{\textbf{XGB Classifier}} & \centering{42} & \centering{1} & \centering{2} & \centering{39}\tabularnewline
	\hline
	\centering{\textbf{XGB Regressor}} & \centering{39} & \centering{4} & \centering{\textbf{0}} & \centering{41}\tabularnewline
	\hline
	\centering{\textbf{Random Forest Classifier}} & \centering{40} & \centering{3} & \centering{2} & \centering{39}\tabularnewline
	\hline
	\centering{\textbf{Random Forest Regressor}} & \centering{40} & \centering{3} & \centering{2} & \centering{39}\tabularnewline
	\hline
\end{tabular}
% Or to place a caption below a table
...
\begin{tabular}{|M{2.0cm}|M{2.0cm}|M{2.0cm}|M{2.0cm}|M{2.0cm}|}
	...
	\centering{} & \centering{\textbf{Pos. as Pos.}} & \centering{\textbf{Neg. as Pos.}} & \centering{\textbf{Pos. as Neg.}} & \centering{\textbf{Neg. as Neg.}}\tabularnewline
	\hline
	\centering{\textbf{AdaBoost Classifier}} & \centering{37} & \centering{6} & \centering{2} & \centering{39}\tabularnewline
	\hline
	\centering{\textbf{AdaBoost Regressor}} & \centering{39} & \centering{4} & \centering{3} & \centering{38}\tabularnewline
	\hline
	\centering{\textbf{XGB Classifier}} & \centering{39} & \centering{4} & \centering{3} & \centering{38}\tabularnewline
	\hline
	\centering{\textbf{XGB Regressor}} & \centering{40} & \centering{3} & \centering{3} & \centering{38}\tabularnewline
	\hline
	\centering{\textbf{Random Forest Classifier}} & \centering{39} & \centering{4} & \centering{2} & \centering{39}\tabularnewline
	\hline
	\centering{\textbf{Random Forest Regressor}} & \centering{39} & \centering{4} & \centering{2} & \centering{39}\tabularnewline
	\hline
\end{tabular}
% Or to place a caption below a table
